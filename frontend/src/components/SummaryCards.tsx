...
const cards = [
  ...
  { key: 'total_tax', label: 'Total Tax', prefix: '₹', format: (v: string) => parseFloat(v).toLocaleString('en-IN', { minimumFractionDigits: 2 }) },
  { key: 'total_discount', label: 'Total Discount', prefix: '₹', format: (v: string) => parseFloat(v).toLocaleString('en-IN', { minimumFractionDigits: 2 }) },
  { key: 'total_shipping', label: 'Total Shipping', prefix: '₹', format: (v: string) => parseFloat(v).toLocaleString('en-IN', { minimumFractionDigits: 2 }) },
